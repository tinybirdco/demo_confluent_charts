    ...
    inspectNode(node, typeChecker, allTypes) {
        ...
        switch (node.kind) {
            ...
            case typescript_1.default.SyntaxKind.ExportSpecifier: {
                const exportSpecifierNode = node;
                const symbol = typeChecker.getExportSpecifierLocalTargetSymbol(exportSpecifierNode);
                if (((_d = symbol === null || symbol === void 0 ? void 0 : symbol.declarations) === null || _d === void 0 ? void 0 : _d.length) === 1) {
                    const declaration = symbol.declarations[0];
                    if (declaration.kind === typescript_1.default.SyntaxKind.ImportSpecifier) {
                        const importSpecifierNode = declaration;
                        const type = typeChecker.getTypeAtLocation(importSpecifierNode);
                        if (((_f = (_e = type.symbol) === null || _e === void 0 ? void 0 : _e.declarations) === null || _f === void 0 ? void 0 : _f.length) === 1) {
